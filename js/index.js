...
/* harmony import */ var _modules_closest_polyfill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/closest-polyfill */ "./src/js/modules/closest-polyfill.js");
/* harmony import */ var _modules_closest_polyfill__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_closest_polyfill__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_cart_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/cart-modal */ "./src/js/modules/cart-modal.js");
/* harmony import */ var _modules_cart_product__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/cart-product */ "./src/js/modules/cart-product.js");
/* harmony import */ var _modules_clock__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/clock */ "./src/js/modules/clock.js");
...
var addOpenHeaderCartHandler = function addOpenHeaderCartHandler() {
  ...
  cartButton.addEventListener('click', function (evt) {
    evt.preventDefault();
    Object(_modules_cart_modal__WEBPACK_IMPORTED_MODULE_4__["default"])();
  });
};
/**
...
var addBuyItemHandlers = function addBuyItemHandlers() {
  ...
  buyButtons.forEach(function (button) {
    button.addEventListener('click', function (evt) {
      evt.preventDefault();
      var idx = parseInt(button.closest('.product').id, 10);
      Object(_modules_cart_product__WEBPACK_IMPORTED_MODULE_5__["addItemToCart"])(idx);
      Object(_modules_cart_modal__WEBPACK_IMPORTED_MODULE_4__["default"])();
    });
  });
};
...
var modalClose = function modalClose(modal) {
  ...
  Object(scroll_lock__WEBPACK_IMPORTED_MODULE_0__["enablePageScroll"])(modal);
};
/**
...
var showModalCart = function showModalCart() {
  ...
  modal.addEventListener('mouseup', function (evt) {
    if (evt.target === modal) {
      modalClose(modal);
    }
  });
  modal.classList.add('modal--show');
  Object(scroll_lock__WEBPACK_IMPORTED_MODULE_0__["disablePageScroll"])(modal);
};

/* harmony default export */ __webpack_exports__["default"] = (showModalCart);

/***/ }),

/***/ "./src/js/modules/cart-product.js":
/*!****************************************!*\
  !*** ./src/js/modules/cart-product.js ***!
  \****************************************/
/*! exports provided: addItemToCart, renderShoppingCartItems, getCartItemsFromLocalStorage, changePricesToOriginal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addItemToCart", function() { return addItemToCart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderShoppingCartItems", function() { return renderShoppingCartItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCartItemsFromLocalStorage", function() { return getCartItemsFromLocalStorage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changePricesToOriginal", function() { return changePricesToOriginal; });
...
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./data */ "./src/js/modules/data.js");
/* harmony import */ var _header_price__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./header-price */ "./src/js/modules/header-price.js");
...
var getCartItemsFromLocalStorage = function getCartItemsFromLocalStorage() {
  ...
  return JSON.parse(localStorage.getItem(_data__WEBPACK_IMPORTED_MODULE_22__["Cart"].KEY));
};
/**
 * Получает данные из LocalStorage
 */
...
var checkActionTerm = function checkActionTerm() {
...
var addEmtpyCartState = function addEmtpyCartState() {
  ...
  var modalCart = document.querySelector('.cart-modal__content');
  var priceElement = document.querySelector('.js-header-price');
...
var deleteAllItems = function deleteAllItems() {
  localStorage.setItem(_data__WEBPACK_IMPORTED_MODULE_22__["Cart"].KEY, '[]');
  addEmtpyCartState();
};
/**
...
var addDeleteAllItemsHandler = function addDeleteAllItemsHandler() {
  var deleteButton = document.querySelector('.js-delete-all');
...
var renderShoppingCartItems = function renderShoppingCartItems(items) {
  var modalCart = document.querySelector('.cart-modal__content');
  ...
  Object(_header_price__WEBPACK_IMPORTED_MODULE_23__["default"])(addedProducts);
...
var deleteItemFromCart = function deleteItemFromCart(id) {
  var oldData = getCartItemsFromLocalStorage();
  var newData = oldData.filter(function (item) {
    return item !== id;
  });
  localStorage.setItem(_data__WEBPACK_IMPORTED_MODULE_22__["Cart"].KEY, JSON.stringify(newData));
...
var addDeleteItemHandlers = function addDeleteItemHandlers() {
  ...
  deleteButtons.forEach(function (button) {
    button.addEventListener('click', function (evt) {
      evt.preventDefault();
      var idx = parseInt(button.closest('.cart-item').id.match(/[\d]/)[0], 10);
...
var addItemToCart = function addItemToCart(id) {
  ...
  var newData = _toConsumableArray(new Set([id].concat(_toConsumableArray(oldData))));
...
var initializeClock = function initializeClock(id, callback) {
  ...
  var updateClock = function updateClock() {
    ...
    minutesSpan.innerHTML = "".concat("0".concat(t.minutes).slice(-2), "m ");
    secondsSpan.innerHTML = "".concat("0".concat(t.seconds).slice(-2), "s");
...
/* harmony default export */ __webpack_exports__["default"] = (initializeClock);

/***/ }),

/***/ "./src/js/modules/closest-polyfill.js":
/*!********************************************!*\
  !*** ./src/js/modules/closest-polyfill.js ***!
  \********************************************/
/*! no static exports found */
...
/*!********************************!*\
  !*** ./src/js/modules/data.js ***!
  \********************************/
/*! exports provided: PRODUCTS, Cart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/js/modules/header-price.js":
/*!****************************************!*\
  !*** ./src/js/modules/header-price.js ***!
  \****************************************/
/*! exports provided: default */
...
var calculateHeaderPrice = function calculateHeaderPrice() {
  var products = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var price = products.reduce(function (acc, product) {
  ...
  if (products.length === 0) {
    ...
    priceElement.textContent = products ? numeral__WEBPACK_IMPORTED_MODULE_1___default()(price).format('0.0.0') : '';
  }
};

/* harmony default export */ __webpack_exports__["default"] = (calculateHeaderPrice);
